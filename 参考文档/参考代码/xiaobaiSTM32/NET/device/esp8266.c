...
#define WIFI_SSID 						"Axiong123"								//	WIFI的名称 必须用2.4G的wifi不能用5G的，且不能用中文、空格
#define WIFI_PSWD 						"11111111"				//	WIFI密码

#define SERVER_HOST						"mqtt.bear321.cn"			//	MQTT服务器域名或IP
...
//	delay_ms(500);
	...
	DEBUG_LOG("0. AT - 测试MCU-8266通讯");
		...
		OLED_ShowString(24,54,(u8*)"111",16);//8*16 “ABC”
		OLED_Refresh();	
	while(ESP8266_SendCmd("AT\r\n", "OK"))
		delay_ms(500);
	OLED_ShowString(24,54,(u8*)"222",16);//8*16 “ABC”
		OLED_Refresh();	
